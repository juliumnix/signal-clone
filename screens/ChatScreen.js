...
import { View, Text, StyleSheet, TouchableOpacity, SafeAreaView, 
  KeyboardAvoidingView, ScrollView, TextInput, Keyboard, TouchableWithoutFeedback } from 'react-native';
...
const ChatScreen = ({navigation, route}) => {
  ...
  useLayoutEffect(() =>{
    ...
    collection('message').orderBy('timestamp', 'desc').onSnapshot(snapshot =>
      setMessages(
